...
$tblPayments = $installer->getConnection()
    ...
    ->addColumn('amount', Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,4', array('nullable' => false), 'Amount')
    ->addColumn('amount_refunded', Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,4', array('nullable' => false), 'Amount Refunded')
    ->addColumn('amount_captured', Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,4', array('nullable' => false), 'Amount Captured')
